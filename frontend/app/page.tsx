	...
	return (
		<TextPage>
			...
			<ul className="list-disc pl-4">
				...
				<li>
					Track your <Link href="/stocks">stock</Link> portfolio, with live price updates
				</li>
				<li>
					A rolling <Link href="/interest">interest</Link> calculator, to help savings calculations
					over time
				</li>
				<li>
					Calculate post-<Link href="/tax">tax</Link> income across different countries with
					different rates and systems
				</li>
				<li>
					Simple <Link href="/budget">budget</Link> app, with options like setting a certain
